...
description: |
   Unlike classic mechine learning, in which the features that machine learnS are extracted manually, artifical neural networks (ANN) can extract features from data automatically. With increase of data amount, ANN (with algorithms of multi-layer percetion, convolutional neural network, etc.) are explored for getting good results. This section will introduce multi-layer precetion (MLP) algorithm.
# author: []
# date: 2023-10-15
# output:
